...
\,\left(\frac{10^{6}\,\mathrm{g\,cm^{-3}}}{\rho_{c}}\right)^{1/2}
  ...
  \end{equation}
  Such a short period means the equatorial velocity is $v_{\mathrm{eq}} \sim 1000\ \mathrm{km\ s^{-1}}$, and so $V_{\mathrm{eq}}^2 / v_{\mathrm{esc}}^2 > 1$. So evidently angular momentum transport and shedding of angular momentum is an essential part of stellar formation, and the youngest stars must be rotating very rapidly.
