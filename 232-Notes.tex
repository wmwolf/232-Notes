...
%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{equation}
      ...
      P=\frac{2}{5}n_e\frac{1}{2 m_e}p_F^2=\frac{n_e}{5
        m_e}\left(\frac{3h^3n_e}{8\pi}\right)^{2/3}=n_e^{5/3}\left(\frac{3h^2}{8\pi}\right)^{2/3}\frac{1}{5 m_e}
    \end{equation}
    ...
    \begin{equation}
      \label{eq:321}
      P=\left(\frac{\rho}{2m_p}\right)^{5/3}\left(\frac{3h^3}{8\pi}\right)^{2/3}\frac{1}{5 m_e}
    \end{equation}
    ...
    \begin{equation}
      \label{eq:322}
      \frac{dP}{dr}=-\rho\frac{Gm(r)}{r^2}\quad\Rightarrow\quad P\sim G\frac{M}{R^2}\frac{M}{R^2}=\frac{GM^2}{R^4}
    \end{equation}
    ...
    \begin{equation}
      \label{eq:323}
      P_c\sim\frac{GM^2}{M^{4/3}}\rho^{4/3}=\frac{1}{5m_e}\left(\frac{\rho}{2m_p}\right)^{5/3}\left(\frac{3h^3}{8\pi}\right)^{2/3}
    \end{equation}
    Solving this for the density gives
    \begin{equation}
      \label{eq:324}
      \rho\sim 4\times 10^5\,\mathrm{g\,cm^{-3}}\left(\frac{M}{0.1\,M_\odot}\right)^2\left(\frac{m_x}{m_e}\right)^3
    \end{equation}
    where $m_x$ is presumably the mass of the degenerate particle (in
    our case, the electron mass).Now this is the crude scaling at low masses and it is important to
    ...
    \begin{equation}
      \label{eq:325}
      R\sim 8\times 10^8\,\mathrm{cm}\left(\frac{0.1\,M_\odot}{M}\right)^{1/3}\left(\frac{m_e}{m_x}\right)
    \end{equation}
    So the star gets smaller as the mass increases. Note that the more
    proper formula is
    \begin{equation}
      \label{eq:326}
      R=2\times 10^9\,\mathrm{cm}\left(\frac{0.1\,M_\odot}{M}\right)^{1/3}\left(\frac{m_e}{m_x}\right)
    \end{equation}
    ...
    \begin{equation}
      \label{eq:327}
      m_ec=p_F=\left(\frac{3h^3n_e}{8\pi}\right)^{1/3}=\left(\frac{3h^3\rho}{2m_p8\pi}\right)^{1/3}
    \end{equation}
    ...
    \begin{equation}
      \label{eq:330}
      P=\frac{1}{4}n_e E_F=\frac{1}{4}n_e p_F c=\frac{1}{4} n_ec\left(\frac{3h^3n_e}{8\pi}\right)^{1/3}=n_e^{4/3}\frac{c}{4}\left(\frac{3h^3}{8\pi}\right)^{1/3}
    \end{equation}
    Relating this to our hydrostatic approximation for the central
    pressure, we find
    \begin{equation}
      \label{eq:331}
      M^{2/3}=\frac{1}{G}\frac{c}{4}\frac{1}{(2m_p)^{4/3}}\left(\frac{3h^3}{8\pi}\right)^{1/3}
    \end{equation}
    Which predicts a characteristic mass of such objects of
    \begin{equation}
      \label{eq:332}
      M+\frac{1}{G^{3/2}}\left(\frac{c}{4}\right)^{3/2}\frac{1}{(2m_p)^2}\left(\frac{3h^3}{8\pi}\right)^{1/2}
      \approx 0.3 M_\odot
    \end{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{align}
      \label{eq:337}
      T\frac{ds}{dt}=\varepsilon_{\mathrm{nuc}}-\frac{dL(r)}{dm(r)}-\varepsilon_\nu
    \end{align}
    ...
    \begin{equation}
      \label{eq:346}
      n_{e^+}=g_e^2n_{e,Q}^2\frac{1}{n_e}\exp\left(-\frac{2m_e c^2}{kT}\right)
    \end{equation}
    Scaling this result, we get
    \begin{equation}
      \label{eq:347}
      n_{e+}=7.7\times 10^{30}\left(\frac{10^4}{\rho}\right)T_9^3\exp\left(-\frac{11.84}{T_9}\right)
    \end{equation}
    \begin{table}[h]
      \centering
      \begin{tabular}{c c}
        ...
        2 & >1
      \end{tabular}
      \caption{Relative densities of positrons and electrons at various temperatures}
      \label{tab:positron}
    \end{table}
    ...
    \begin{equation}
      \label{eq:349}
      n_{e^+}n_{e^-}=4\left(\frac{2\pi m_e kT}{h^3}\right)^3\exp\left(-\frac{2m_ec^2}{kT}\right)
    \end{equation}
    ...
    \begin{equation}
      \label{eq:351}
      \sigma = 1.4\times 10^{-45}\frac{c}{v}\left[\left(\frac{W}{m_ec^2}\right)^2-1\right]\,\mathrm{cm^2}
    \end{equation}
    ...
    \begin{equation}
      \label{eq:353}
      \frac{dU_\nu}{dt}=5\times 10^{18}T_9^3\exp\left(-\frac{11.84}{T_9}\right)\mathrm{erg\,cm^{-3}\,s^{-1}}
    \end{equation}
    ...
    \begin{equation}
      \label{eq:355}
      t_{\mathrm{cool}}\sim\frac{E_{\mathrm{th}}}{dU_\nu/dt}=14\,\mathrm{s}\,\frac{\rho_4}{T_9^2}\exp\left(\frac{11.84}{T_9}\right)
    \end{equation}
    \begin{table}[h]
      \centering
      \begin{tabular}{c c}
        ...
        2 & 0.4 hours
      \end{tabular}
      \caption{Neutrino cooling time scale for various temperature assuiming $\rho_4=1$.}
      \label{tab:cooling}
    \end{table}
    ...
    \begin{figure}[h]
      ...
      \caption{Rough sketch of the limits where neutrino cooling becomes dominant.}
      \label{fig:cooling}
    \end{figure}
