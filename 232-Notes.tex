...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    sufficiently high that ignoring the $+1$ in the denominator of the
    ...
    is actually the dominant soource of opacity in the sun's photosphere.
