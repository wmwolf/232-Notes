...
\label{sec:conv-effic}
  ...
  \begin{equation}
    \label{eq:57}
    kT_{\mathrm{eff}}=0.6\left(\frac{GM\mum_p}{R}\right)\left(\frac{R^2}{M\kappa_{\mathrm{ph}}}\right)^{2/5}
  \end{equation}
  ...
  \end{equation}
  So we have a big problem with assumign electron scattering (or convection).
\end{document}
