...
int_0^\infty v^3\sigma(v)\exp\left(-\frac{\mu v^2}{2kT}\right)dv
  ...
  \end{equation}
  Using the WKB approxiamtion to calculate the barrier penetration,
  which assumes that the lengthscale of changes in $V(r)$ is much
  larger than the DeBroglie wavelength of the particle, we get the
  ...
  physics. Often this is written in terms of the reduced wavelenth,
  $\lambda/2\pi$.
  \begin{equation}
    \label{eq:124}
  ...
  \begin{equation}
    ...
    \mathrm{barns}\ \left(\mathrm{\frac{keV}{E}}\right)
  \end{equation}
